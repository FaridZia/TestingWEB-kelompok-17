                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            ...
                                            <!-- Edit The Modal -->
                                            <div class="modal fade" id="edit<?= $idk; ?>" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        ...
                                                        <form method="POST" action="function.php">
                                                            <div class="modal-body">
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" value="<?= $penerima; ?>" name="penerima" required>
                                                                </div>
                                                                <div class="mb-3">
                                            ...
                                            <!-- Delete The Modal -->
                                            <div class="modal fade" id="delete<?= $idk; ?>" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" action="function.php">
                ...
                <div class="mb-3">
                    <input type="number" class="form-control" id="Quantity" name="qty" placeholder="Quantity" required>
                </div>
                <br>
